 ...
 *
 * @example
 * {{ 'https://example.com' | qrCode }} // Generates an SVG QR code.
 * {{ 'https://example.com' | qrCode: { elementType: 'canvas', width: 300 } }} // Generates a canvas QR code with width 300.
 * {{ 'https://example.com' | qrCode: { colorDark: '#008000ff', colorLight: '#f0f0f0ff' } }} // Generates a QR code with custom colors.
 * {{ null | qrCode }} // Resolves to ''
 * {{ undefined | qrCode }} // Resolves to ''
 * 
 * @author Mofiro Jean
 */
@Pipe({
